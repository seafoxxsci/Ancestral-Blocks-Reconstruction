...
def parser_code():
    ...
    parser.add_argument("--filter", "-f", dest="filter", metavar="FILTER_FILE", default='',
        help="Optional input file specifying which accession numbers this script will process (each accession must be \
        a new line). If no file is provided, filtering is not performed [default: NONE]")     
